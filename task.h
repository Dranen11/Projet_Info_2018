...
public slots:
    void run()
    {
        ...
        sphericalSource star2(2,vecteur<double,3>({0.,0.,2.4e20}),vecteur<double,3>({0.,0.,0.}),vecteur<double,3>({1.,1.,1.}),3.e11);
        ...
        obs.set_objectList({&star, &body, &star2});
